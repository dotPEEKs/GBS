...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.brcode_type = QLabel(self.centralwidget)
        self.brcode_type.setObjectName(u"brcode_type")
        self.brcode_type.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout.addWidget(self.brcode_type)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.item_name.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u00fcr\u00fcn ad\u0131", None))
        self.item_barcode.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u00fcr\u00fcn barkodu", None))
        self.brcode_type.setText("")
