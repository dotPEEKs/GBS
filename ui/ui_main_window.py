...
from PySide6.QtWidgets import (QApplication, QComboBox, QFrame, QHBoxLayout,
    ...
    QPushButton, QScrollBar, QSizePolicy, QTableWidget,
...
"}")
        ...
        self.verticalScrollBar = QScrollBar(self.frame_4)
        ...
        self.tableWidget.setEditTriggers(QAbstractItemView.NoEditTriggers) # disable cells editable
        self.tableWidget.setObjectName(u"tableWidget")
        self.tableWidget.horizontalHeader().setSectionResizeMode(QHeaderView.Stretch) # başlıklari genişlettik ve daha uygun gösterdik
